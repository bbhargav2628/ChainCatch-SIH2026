...
DEMO_CASES = {
    ...
    "CASE-2-CROSSCHAIN": {
        ...
        "signals": {
            "fund_flow_continuity": 0.82,
            "wallet_proximity": 0.75,
            "transaction_timing": 0.70,
            "amount_correlation": 0.80,
            "vasp_interaction": 0.85,
            "cluster_behavior": 0.60,
